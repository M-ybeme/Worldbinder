CREATE TYPE "public"."security_event_type" AS ENUM('user_registered', 'email_verified', 'login_succeeded', 'login_failed', 'password_changed', 'password_reset_requested', 'password_reset_completed', 'session_revoked', 'refresh_reuse_detected', 'account_deactivated');--> statement-breakpoint
